...
#include "../CMSIS/device/stm32f0xxSystemWorkbench.h"
#include <stdint.h>
#include "lcd.h"
...
#define RESET_HIGH do { GPIOB->BSRR = GPIO_BSRR_BS_14; } while(0)
#define RESET_LOW  do { GPIOB->BSRR = GPIO_BSRR_BR_14; } while(0)
#define DC_NUM 8
#define DC_BIT (1<<DC_NUM)
#define DC_HIGH do { GPIOB->BSRR = GPIO_BSRR_BS_8; } while(0)
#define DC_LOW  do { GPIOB->BSRR = GPIO_BSRR_BR_8; } while(0)
...
void init_lcd_spi(void){
    ...
    //#define PB_MOSI (5)
    //#define PB_SCK (3)
    //#define PB_DC (10) Prior: 8
    //#define PB_CS (11) Prior: 11
    //#define PB_RST (12) Prior: 14
    GPIOB->MODER &= ~(GPIO_MODER_MODER10 | GPIO_MODER_MODER11 |GPIO_MODER_MODER12|GPIO_MODER_MODER3|GPIO_MODER_MODER5);
    GPIOB->MODER|= GPIO_MODER_MODER10_0|GPIO_MODER_MODER11_0|GPIO_MODER_MODER12_0; //For DC,CS,RST into general purpose output mode 01
    GPIOB->MODER|= GPIO_MODER_MODER3_1|GPIO_MODER_MODER5_1; // Bits for MOSI and SCK for ALt function mode 10
    GPIOB->AFR[0] &=~(GPIO_AFRL_AFR3|GPIO_AFRL_AFR5); //Alt function MOSI,SCK turned high
    GPIOB->BSRR = GPIO_BSRR_BS_10|GPIO_BSRR_BS_11|GPIO_BSRR_BS_12; // DC,CS,RST Sets corresponding ODRx bit
